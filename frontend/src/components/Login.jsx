        ...
        try{
            ...
            if(!profile && token){
                try{
                    ...
                    console.err("Could Not Fetch Profile after Login token", fetchErr);
                    profile = {email};
                }
            }
            ...
            if(typeof onLogin === "function"){
                try{
                    ...
                    console.warn("onLogin throw :", err);
                    navigate("/");
                }
            }else{
                navigate("/");
        ...
        <div className={loginStyles.cardContainer}>
            ...
            <div className={loginStyles.formContainer}>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <button type='submit' disabled = {isLoding} className={`${loginStyles.button} ${
                        isLoding ? loginStyles.buttonDisabled : ""
                    }`}>
                        {isLoding ? (
                            <>
