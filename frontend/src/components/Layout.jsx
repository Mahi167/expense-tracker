...
import {styles} from "../assets/dummyStyle.js";
import { useState,useEffect } from 'react';
import Navbar from './Navbar'
import Sidebar from "./Sidebar";
import { ArrowDown, ArrowUp, Car, ChevronDown, ChevronUp, Clock, CreditCard, DollarSign, Gift, Home, Info, PieChart, PiggyBank, RefreshCcw, RefreshCw, ShoppingCart, TrendingUp, Utensils, Zap } from 'lucide-react';
          ...
          <div className={styles.grid.rightColumn}>
            ...
            <div className={styles.cards.base}>
              ...
              <div className={styles.categories.list}>
                {topCategories.map(([catagory, amount]) => (
                  <div key={catagory} className={styles.categories.categoryItem}>
                    <div className='flex items-center gap-3'>
                      <div className={styles.categories.catagoryIconContainer}>
                        {CATEGORY_ICONS[catagory] || (
                    ...
                    <span className={styles.categories.categoryAmount}></span>
                    ${amount}
                  </div>
                ))}
              </div>
