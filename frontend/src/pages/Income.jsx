...
import { incomeStyles as styles } from "../assets/dummyStyle.js";
...
const Income = () => {
  ...
  const chartData = useMemo(() => {
    // Deep clone point objects to prevent unexpected structural mutation side-effects
    ...
    filteredTransactions.forEach((transaction) => {
      ...
      if (index !== -1) {
        data[index].income += Math.round(Number(transaction.amount || 0));
      }
    });
  ...
  const handleAddTransaction = useCallback(async () => {
    ...
    try {
      ...
      const payload = {
        ...
        category: newTransaction.category, // Fixed structure
  ...
  const handleEditTransaction = useCallback(async () => {
    ...
    try {
      ...
      const payload = {
        ...
        category: editForm.category, // Fixed structure
