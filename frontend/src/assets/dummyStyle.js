...
export const profileStyles = {
  ...
  cardTitle: "text-xl font-semibold pb-3 text-gray-800 flex gap-3",
  ...
  editButton: "text-teal-600 hover:text-teal-700 font-medium text-sm  p-4",
...
export const navbarStyles = {
  ...
  dropdownAvatar: "w-10 h-10 p-4 rounded-full bg-gradient-to-br from-teal-600 to-cyan-500 flex items-center justify-center text-white font-bold text-lg",
  dropdownName: "text-sm text-gray-800 ",
  dropdownEmail: "text-sm text-gray-500 truncate max-w-[140px]",
...
export const sidebarStyles = {
  ...
  // Toggle button
  toggleButton: {
    // base : "absolute top-10 -right-4 flex items-center bg-white border border-gray-300 justify-center w-8 h-8  rounded-full  bg-white  border  shadow-md  z-50 hover:text-teal-600 hover:border-teal-400 hover:bg-teal-50 transition-all"
