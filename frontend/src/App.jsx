...
// to protect the routes
  ...
  // to scroll to top when page get reload or new page
  const ScrollToTop = () => {
...
const App = () => {
  ...
  // to update the user data both in the state 
  ...
  // try to load user with token whne mounted
  useEffect(() => {
    (async () => {
      try{
        ...
        JSON.parse(sessionUserRaw) : null;
         ...
         if(storedToken){
          try{
            ...
            console.warn("Could Not Fetch Profile with the stored ", err);
          }
        }
        } catch(err){
  ...
  return (
    ...
    <ScrollToTop/>
     ...
     <Route path="/login"  element={<Login onLogin={handleLogin}/>}/>
      <Route path="/signup" element={<Signup onSignup={handleSignup} persistAuth={persistAuth}/>} />
        <Route element={
